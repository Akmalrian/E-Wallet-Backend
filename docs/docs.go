    ...
    "paths": {
        "/auth/enter-pin": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Enter PIN Request",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.EnterPinBody"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ForgotPasswordBody"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ResetPasswordBody"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.HistoryResponse": {
            ...
            "properties": {
                ...
                "sender_info": {
                    "$ref": "#/definitions/dto.SenderInfo"
                },
                "status": {
                    "type": "string"
                },
